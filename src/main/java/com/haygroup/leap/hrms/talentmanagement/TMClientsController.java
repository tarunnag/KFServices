...
public class TMClientsController {
...
private static final Logger logger = LoggerFactory.getLogger(TMProjectsController.class);
	...
	public void getTMClientMetadata(
			...
			HttpServletRequest request,	HttpServletResponse response)
	{
		...
		talentArchitectRestProxy.stream("getTMClientMetadata", request, response, new String[] { clientId, locale, projectId });
